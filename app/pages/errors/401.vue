    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">
                Este usuario no esta registrado en el sistema y/o esta <strong>DESHABILITADO</strong> <br />
                Pongase en contacto con el Soporte para solicitar acceso
            </p>

            <p>
                <b>Soporte de usuarios</b><br />
                Unidad de seguridad y atencion al cliente<br />
                Departamento de innovacion y desarrollo
            </p>
            <p>Por teléfono: XX.XXX.XX.XX</p>
            <p>
                Correo electrónico:
                <a :href="'mailto:${contactEmail}'">soporte@hmedinas.es</a>
            </p>
